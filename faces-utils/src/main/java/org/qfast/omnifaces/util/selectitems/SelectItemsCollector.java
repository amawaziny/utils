...
import org.qfast.omnifaces.el.ScopedRunner;
import org.qfast.omnifaces.model.ExtendedSelectItem;
import org.qfast.omnifaces.util.Callback;
import static org.qfast.util.Util.isEmpty;
...
public final class SelectItemsCollector {
     ...
     * <code>UISelectItems<code> component that uses the
     * <code>var</code> iterator construct to generate a list of
    ...
    /**
     * Gets the name boolean attribute. It defaults to
