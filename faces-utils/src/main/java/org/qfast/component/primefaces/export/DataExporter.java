...
public class DataExporter implements ActionListener, StateHolder {
    ...
    public void processAction(ActionEvent event) {
        ...
        String outputFileName = fileName.getValue(elContext).toString();
        ...
        try {
            ...
            if (component instanceof DataTable) {
                ...
                PanelGrid table = (PanelGrid) component;
                exporter.export(context, table, outputFileName, isPageOnly, isSelectionOnly, encodingType, preProcessor, postProcessor);
            } else {
                throw new FacesException("Unsupported datasource target:\"" + component.getClass().getName() + "\", exporter must target a PrimeFaces DataTable or PanelGrid.");
            }
